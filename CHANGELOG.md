...
- Bump Java SDK (Android) from v8.2.0 to v8.13.1 ([#37](https://github.com/jayhf/sentry-unreal/pull/37))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8131)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.13.1)
