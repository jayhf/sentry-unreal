...
- Bump Java SDK (Android) from v8.2.0 to v8.50.1 ([#206](https://github.com/jayhf/sentry-unreal/pull/206))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8501)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.50.1)
