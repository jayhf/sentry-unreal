...
- Bump Java SDK (Android) from v8.2.0 to v8.22.0 ([#74](https://github.com/jayhf/sentry-unreal/pull/74))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8220)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.22.0)
