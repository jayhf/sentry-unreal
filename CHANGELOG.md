...
- Bump Java SDK (Android) from v8.2.0 to v8.39.0 ([#156](https://github.com/jayhf/sentry-unreal/pull/156))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8390)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.39.0)
