...
- Bump Java SDK (Android) from v8.2.0 to v8.53.0 ([#214](https://github.com/jayhf/sentry-unreal/pull/214))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8530)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.53.0)
