...
- Bump Java SDK (Android) from v8.2.0 to v8.52.0 ([#212](https://github.com/jayhf/sentry-unreal/pull/212))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8520)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.52.0)
