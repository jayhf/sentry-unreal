...
- Bump Java SDK (Android) from v8.2.0 to v8.15.1 ([#48](https://github.com/jayhf/sentry-unreal/pull/48))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8151)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.15.1)
