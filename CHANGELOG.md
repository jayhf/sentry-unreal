...
- Bump Java SDK (Android) from v8.2.0 to v8.13.3 ([#43](https://github.com/jayhf/sentry-unreal/pull/43))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8133)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.13.3)
