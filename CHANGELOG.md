...
- Bump Java SDK (Android) from v8.2.0 to v8.57.0 ([#228](https://github.com/jayhf/sentry-unreal/pull/228))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8570)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.57.0)
