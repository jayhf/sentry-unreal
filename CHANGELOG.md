...
- Bump Java SDK (Android) from v8.2.0 to v8.35.0 ([#141](https://github.com/jayhf/sentry-unreal/pull/141))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8350)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.35.0)
