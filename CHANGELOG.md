...
- Bump Java SDK (Android) from v8.2.0 to v8.44.0 ([#184](https://github.com/jayhf/sentry-unreal/pull/184))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8440)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.44.0)
