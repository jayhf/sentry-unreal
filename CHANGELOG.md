...
- Bump Java SDK (Android) from v8.2.0 to v8.12.0 ([#32](https://github.com/jayhf/sentry-unreal/pull/32))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8120)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.12.0)
