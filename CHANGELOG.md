...
- Bump Java SDK (Android) from v8.2.0 to v8.26.0 ([#95](https://github.com/jayhf/sentry-unreal/pull/95))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8260)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.26.0)
