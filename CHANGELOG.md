...
- Bump Java SDK (Android) from v8.2.0 to v8.44.1 ([#187](https://github.com/jayhf/sentry-unreal/pull/187))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8441)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.44.1)
