...
- Bump Java SDK (Android) from v8.2.0 to v8.29.0 ([#106](https://github.com/jayhf/sentry-unreal/pull/106))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8290)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.29.0)
