...
- Bump Java SDK (Android) from v8.2.0 to v8.21.0 ([#69](https://github.com/jayhf/sentry-unreal/pull/69))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8210)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.21.0)
