...
- Bump Java SDK (Android) from v8.2.0 to v8.36.0 ([#142](https://github.com/jayhf/sentry-unreal/pull/142))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8360)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.36.0)
