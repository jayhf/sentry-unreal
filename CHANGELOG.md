...
- Bump Java SDK (Android) from v8.2.0 to v8.37.0 ([#146](https://github.com/jayhf/sentry-unreal/pull/146))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8370)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.37.0)
