...
- Bump Java SDK (Android) from v8.2.0 to v8.48.0 ([#198](https://github.com/jayhf/sentry-unreal/pull/198))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8480)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.48.0)
