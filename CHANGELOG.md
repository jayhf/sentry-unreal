...
- Bump Java SDK (Android) from v8.2.0 to v8.19.1 ([#62](https://github.com/jayhf/sentry-unreal/pull/62))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8191)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.19.1)
