...
- Bump Java SDK (Android) from v8.2.0 to v8.27.1 ([#98](https://github.com/jayhf/sentry-unreal/pull/98))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8271)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.27.1)
