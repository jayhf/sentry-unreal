...
- Bump Java SDK (Android) from v8.2.0 to v8.58.0 ([#232](https://github.com/jayhf/sentry-unreal/pull/232))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8580)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.58.0)
