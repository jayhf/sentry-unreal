...
- Bump Java SDK (Android) from v8.2.0 to v8.54.0 ([#219](https://github.com/jayhf/sentry-unreal/pull/219))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8540)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.54.0)
