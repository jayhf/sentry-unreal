...
- Bump Java SDK (Android) from v8.2.0 to v8.25.0 ([#88](https://github.com/jayhf/sentry-unreal/pull/88))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8250)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.25.0)
