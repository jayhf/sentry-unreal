...
- Bump Java SDK (Android) from v8.2.0 to v8.46.0 ([#191](https://github.com/jayhf/sentry-unreal/pull/191))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8460)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.46.0)
