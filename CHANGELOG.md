...
- Bump Java SDK (Android) from v8.2.0 to v8.41.0 ([#166](https://github.com/jayhf/sentry-unreal/pull/166))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8410)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.41.0)
