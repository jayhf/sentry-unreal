...
- Bump Java SDK (Android) from v8.2.0 to v8.50.0 ([#205](https://github.com/jayhf/sentry-unreal/pull/205))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8500)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.50.0)
