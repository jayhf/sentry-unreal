...
- Bump Java SDK (Android) from v8.2.0 to v8.23.0 ([#80](https://github.com/jayhf/sentry-unreal/pull/80))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8230)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.23.0)
