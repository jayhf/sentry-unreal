...
- Bump Java SDK (Android) from v8.2.0 to v8.14.0 ([#44](https://github.com/jayhf/sentry-unreal/pull/44))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8140)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.14.0)
