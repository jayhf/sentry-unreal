...
- Bump Java SDK (Android) from v8.2.0 to v8.16.0 ([#49](https://github.com/jayhf/sentry-unreal/pull/49))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8160)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.16.0)
