...
- Bump Java SDK (Android) from v8.2.0 to v8.39.1 ([#157](https://github.com/jayhf/sentry-unreal/pull/157))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8391)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.39.1)
