...
- Bump Java SDK (Android) from v8.2.0 to v8.11.1 ([#27](https://github.com/jayhf/sentry-unreal/pull/27))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8111)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.11.1)
