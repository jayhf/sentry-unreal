...
- Bump Java SDK (Android) from v8.2.0 to v8.28.0 ([#101](https://github.com/jayhf/sentry-unreal/pull/101))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8280)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.28.0)
