...
- Bump Java SDK (Android) from v8.2.0 to v8.24.0 ([#86](https://github.com/jayhf/sentry-unreal/pull/86))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8240)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.24.0)
