...
- Bump Java SDK (Android) from v8.2.0 to v8.27.0 ([#97](https://github.com/jayhf/sentry-unreal/pull/97))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8270)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.27.0)
