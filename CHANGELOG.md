...
- Bump Java SDK (Android) from v8.2.0 to v8.51.0 ([#209](https://github.com/jayhf/sentry-unreal/pull/209))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8510)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.51.0)
