...
- Bump Java SDK (Android) from v8.2.0 to v8.43.2 ([#180](https://github.com/jayhf/sentry-unreal/pull/180))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8432)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.43.2)
