...
- Bump Java SDK (Android) from v8.2.0 to v8.34.0 ([#134](https://github.com/jayhf/sentry-unreal/pull/134))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8340)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.34.0)
