...
- Bump Java SDK (Android) from v8.2.0 to v8.34.1 ([#136](https://github.com/jayhf/sentry-unreal/pull/136))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8341)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.34.1)
