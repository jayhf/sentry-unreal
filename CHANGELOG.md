...
- Bump Java SDK (Android) from v8.2.0 to v8.21.1 ([#70](https://github.com/jayhf/sentry-unreal/pull/70))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8211)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.21.1)
