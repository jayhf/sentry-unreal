...
- Bump Java SDK (Android) from v8.2.0 to v8.33.0 ([#125](https://github.com/jayhf/sentry-unreal/pull/125))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8330)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.33.0)
