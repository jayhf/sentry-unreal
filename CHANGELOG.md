...
- Bump Java SDK (Android) from v8.2.0 to v8.20.0 ([#65](https://github.com/jayhf/sentry-unreal/pull/65))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8200)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.20.0)
