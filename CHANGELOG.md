...
- Bump Java SDK (Android) from v8.2.0 to v8.10.0 ([#23](https://github.com/jayhf/sentry-unreal/pull/23))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8100)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.10.0)
