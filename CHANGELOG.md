...
- Bump Java SDK (Android) from v8.2.0 to v8.30.0 ([#112](https://github.com/jayhf/sentry-unreal/pull/112))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8300)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.30.0)
