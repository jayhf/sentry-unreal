...
- Bump Java SDK (Android) from v8.2.0 to v8.40.0 ([#160](https://github.com/jayhf/sentry-unreal/pull/160))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8400)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.40.0)
