...
- Bump Java SDK (Android) from v8.2.0 to v8.32.0 ([#121](https://github.com/jayhf/sentry-unreal/pull/121))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8320)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.32.0)
