...
- Bump Java SDK (Android) from v8.2.0 to v8.45.0 ([#190](https://github.com/jayhf/sentry-unreal/pull/190))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8450)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.45.0)
