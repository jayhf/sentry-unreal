...
- Bump Java SDK (Android) from v8.2.0 to v8.18.0 ([#56](https://github.com/jayhf/sentry-unreal/pull/56))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8180)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.18.0)
