...
- Bump Java SDK (Android) from v8.2.0 to v8.55.0 ([#222](https://github.com/jayhf/sentry-unreal/pull/222))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8550)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.55.0)
