...
- Bump Java SDK (Android) from v8.2.0 to v8.47.0 ([#194](https://github.com/jayhf/sentry-unreal/pull/194))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8470)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.47.0)
