...
- Bump Java SDK (Android) from v8.2.0 to v8.17.0 ([#52](https://github.com/jayhf/sentry-unreal/pull/52))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8170)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.17.0)
