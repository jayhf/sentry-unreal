...
- Bump Java SDK (Android) from v8.2.0 to v8.38.0 ([#153](https://github.com/jayhf/sentry-unreal/pull/153))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8380)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.38.0)
