...
- Bump Java SDK (Android) from v8.2.0 to v8.42.0 ([#171](https://github.com/jayhf/sentry-unreal/pull/171))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8420)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.2.0...8.42.0)
